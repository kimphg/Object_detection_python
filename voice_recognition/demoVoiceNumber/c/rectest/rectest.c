...
{
	//AudioEngineMaster *aeMaster = static_cast<AudioEngineMaster*>(user);
...
void StartRecording()
{
	...
	wf->wFormatTag = 1;//Type of WAVE format. This is a PCM header = $01 (linear quntization). Other values indicates some forms of compression.
	wf->nChannels = CHANS;
